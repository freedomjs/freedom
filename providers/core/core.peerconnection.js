...
function PeerConnection(portModule, dispatchEvent,
  ...
  // The core.RTCPeerConnection object for talking to the peer.
  this.peer = null;
...
PeerConnection.prototype.setup = function (signallingChannelId, peerName,
  ...
  if (typeof mocks.RTCPeerConnection !== 'undefined') {
    RTCPeerConnectionAdapter.setImpl(mocks);
  }
  this.peer = new RTCPeerConnectionAdapter.provider(
    undefined, this.dispatchEvent, stunServers);
