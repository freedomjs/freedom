...
// TODO - re-enable these tests when websocker server available again
...
describe("integration: storage.isolated.json",
         require("./storage/storage.integration.src")
         .bind(this, window.freedom,
               "providers/storage/isolated/storage.isolated.json", {}, false));
...
describe("integration: Module Environment",
         require("./coreIntegration/environment.integration.src").bind(
           this, setup));
...
describe("integration: core.xhr", 
         require("./coreIntegration/xhr.integration.src").bind(
           this, require("../../providers/core/core.xhr"), setup));

// core.oauth
describe("integration: core.oauth - localpageauth",
         require("./coreIntegration/oauth.integration.src").bind(
           this, require("../../providers/core/core.oauth"),
           [require("../../providers/oauth/oauth.localpageauth")],
           ["http://localhost:9876/", "http://localhost:9876/debug.html",
